    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'User with that email address already exists.'}, help_text='Required. 128 characters or fewer. Letters, digits and @/./-/_ only.', max_length=128, unique=True, verbose_name='email address')),
